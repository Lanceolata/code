//package com.lanceolata.coding.snippets.common.java.common.config;
//
//import com.lanceolata.coding.snippets.common.java.common.config.types.Password;
//
//import java.util.*;
...
//     * @param name          the name of the config parameter                                                    参数名称
//     * @param type          the type of the config                                                              配置类型
//     * @param defaultValue  the default value to use if this config isn't present                               默认值
//     * @param validator     the validator to use in checking the correctness of the config                      检查参数是否合法
//     * @param importance    the importance of this config                                                       重要性
//     * @param documentation the documentation string for the config                                             说明
//     * @param group         the group this config belongs to                                                    分组
//     * @param orderInGroup  the order of this config in the group                                               分组顺序
//     * @param width         the width of the config                                                             值宽度
//     * @param displayName   the name suitable for display                                                       展示名称
//     * @param dependents    the configurations that are dependents of this configuration                        下游依赖
//     * @param recommender   the recommender provides valid values given the parent configuration values         根据父配置，提供有效值
