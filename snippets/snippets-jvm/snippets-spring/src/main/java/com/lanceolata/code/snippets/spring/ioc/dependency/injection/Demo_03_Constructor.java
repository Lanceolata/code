...
/**
 * 依赖 Constructor方法 注入示例
 */
public class Demo_03_Constructor {
    ...
    private static void injectByAnnotation() {
        ...
        applicationContext.register(Demo_03_Constructor.class);
    ...
    private static BeanDefinition createUserHolderBeanDefinition() {
        ...
        definitionBuilder.addConstructorArgReference("xmlUser1");
