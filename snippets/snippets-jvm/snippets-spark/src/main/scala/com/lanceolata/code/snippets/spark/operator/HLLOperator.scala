...
import com.lanceolata.code.snippets.common.scala.util.HLLUtils
 ...
 */
class HLLOperator(@(transient @param)dataset: Dataset[(FieldValueTag, String)]) extends Serializable {
  /**
   * 生成HLL数据
   *
   * @return
